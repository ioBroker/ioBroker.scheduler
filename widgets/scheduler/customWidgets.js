...
let __tla = (async () => {
  var _a, _b;
  var r = {}, i = /* @__PURE__ */ new Set(), a = /* @__PURE__ */ new Map();
  function o(e2, t2) {
    let n2 = a.get(e2);
  ...
  var c = {
    "./SchedulerWidget": async () => {
      await s(`./SchedulerWidget`), await Promise.all([]);
      let t2 = await o(`./SchedulerWidget`, () => e(() => import("./assets/SchedulerWidget-B0L56g8N.js").then(async (m2) => {
        await m2.__tla;
        return m2;
    ...
    "./translations": async () => {
      ...
      let t2 = await o(`./translations`, () => e(() => import("./assets/translations-CKAFcKay.js").then(async (m2) => {
        await m2.__tla;
        return m2;
      }), [], import.meta.url)), n2 = t2 && t2.__mf_remote_dependency_pending;
      n2 && typeof n2.then == `function` && await n2;
  ...
  var l = `__mf_init__virtual:mf:__mfe_internal__vis_mf_2_2_mf_2_scheduler__mf_owner__195610562247234__mf_v__runtimeInit__mf_v__.js__`, u = globalThis[l];
  if (!u) {
  ...
  var p = globalThis[f];
  for (let e2 of Object.keys(p.share)) if (e2.startsWith(`default:`)) {
    let t2 = e2.slice(8);
  ...
  var S = /* @__PURE__ */ Symbol(`mf.originalSharedProvider`), C = {
    emit: (e2) => e2
    ...
    var _a2;
    if (!e2 || !r2) return;
    let a2 = Object.fromEntries(Object.entries(e2).filter(([, e3]) => {
      var _a3;
      return ((_a3 = e3 == null ? void 0 : e3.shareConfig) == null ? void 0 : _a3.import) !== false;
    }));
    if (Object.keys(a2).length === 0) return;
    let o2 = w(r2), s2 = T(a2, i2), c2 = {};
    for (let e3 of o2) c2[e3 || `default`] = {
      [t2]: s2
    };
    let l2 = (_a2 = n.getRegisteredShare(c2, t2, {
      ...r2,
      scope: o2,
      strategy: i2
    }, C)) == null ? void 0 : _a2.shared;
    return (l2 == null ? void 0 : l2[S]) || l2;
  }, O = (e2, t2, n2, r2) => {
    var _a2;
    let i2 = (e3) => k(e3, n2), a2 = Object.fromEntries(Object.entries(e2 || {}).filter(([, e3]) => {
      var _a3;
  ...
  }, k = (e2, t2) => e2 === t2 || !!((t2 == null ? void 0 : t2.from) && (e2 == null ? void 0 : e2.from) === t2.from), A = (e2, t2, n2, r2, i2, a2, o2, s2, c2) => {
    var _a2, _b2, _c;
    if (c2 !== `version-first` || !s2) return;
    let l2 = (_b2 = (_a2 = t2 == null ? void 0 : t2.options) == null ? void 0 : _a2.shared) == null ? void 0 : _b2[i2], u2 = Array.isArray(l2) ? l2.find((e3) => (e3 == null ? void 0 : e3.version) === a2) : void 0, d2 = ((s2 == null ? void 0 : s2.from) === ((_c = t2 == null ? void 0 : t2.options) == null ? void 0 : _c.name) ? s2 : void 0) || (k(u2, s2) ? u2 : t2 ? void 0 : s2);
    ...
    if (u2 && (!a2.registered || k(u2, s2))) return {
      provider: u2,
      scopeRootProvider: l2
    };
  };
  async function j() {
    return y || (y = x(() => e(() => import("./assets/_virtual_mf-localSharedImportMap___mfe_internal__vis_mf_2_2_mf_2_scheduler__mf_owner__1-Cf7OxlIZ.js").then(async (m2) => {
      await m2.__tla;
      return m2;
  ...
  N = async function(e2 = {}, n2 = [], r2 = {}) {
    ...
    let i2 = (e3, t2, n3, r3) => {
    ...
    }, o2 = /* @__PURE__ */ Symbol.for(`module-federation.shared-cache-listeners`), s2 = /* @__PURE__ */ Symbol.for(`module-federation.shared-cache-owners`), c2 = (e3) => {
      let t2 = e3[s2];
      ...
      let l3 = (_a3 = e3[o2]) == null ? void 0 : _a3[t2.canonical];
      if (l3) for (let e4 of l3) e4(n3);
      return n3;
    }, f2 = /* @__PURE__ */ Symbol.for(`module-federation.tree-shaking-shared-cache`), y2 = (e3) => {
      let t2 = e3[f2];
      return t2 === void 0 && (t2 = /* @__PURE__ */ Object.create(null), Object.defineProperty(e3, f2, {
        value: t2,
        enumerable: false,
        configurable: false,
        writable: false
      ...
      let i3 = [
        ...new Set(n3)
      ].sort(), a3 = y2(e3), o3 = a3[_a3 = t2.canonical] || (a3[_a3] = []), s3 = o3.find((e4) => e4.providedExports.length === i3.length && e4.providedExports.every((e5, t3) => e5 === i3[t3]));
      return s3 ? s3.value = r3 : o3.push({
        providedExports: i3,
        value: r3
      }), r3;
    }, C2 = /* @__PURE__ */ Symbol.for(`module-federation.tree-shaking-shared-selection-cache`), w2 = (e3) => {
      let t2 = e3[C2];
      return t2 === void 0 && (t2 = /* @__PURE__ */ Object.create(null), Object.defineProperty(e3, C2, {
        value: t2,
        enumerable: false,
        configurable: false,
        writable: false
      ...
      var _a3, _b3;
      let r3 = a2(e3, t2);
      return r3 === void 0 ? (_b3 = (_a3 = e3[C2]) == null ? void 0 : _a3[t2.canonical]) == null ? void 0 : _b3[n3] : r3;
    }, A2 = (e3, t2, n3, r3) => {
      var _a3;
      let i3 = w2(e3), a3 = i3[_a3 = t2.canonical] || (i3[_a3] = /* @__PURE__ */ Object.create(null));
      return a3[n3] = r3, r3;
    }, M2 = ((_a2 = globalThis.__FEDERATION__) == null ? void 0 : _a2.__INSTANCES__) || [], N2 = (_b2 = n2.find((e3) => e3 == null ? void 0 : e3.from)) == null ? void 0 : _b2.from, P2 = M2.find((t2) => {
      var _a3, _b3;
      return ((_a3 = t2 == null ? void 0 : t2.options) == null ? void 0 : _a3.name) === N2 && ((_b3 = t2 == null ? void 0 : t2.shareScopeMap) == null ? void 0 : _b3.default) === e2;
    }) || M2.find((t2) => {
      var _a3, _b3;
      return ((_a3 = t2 == null ? void 0 : t2.options) == null ? void 0 : _a3.name) !== _ && ((_b3 = t2 == null ? void 0 : t2.shareScopeMap) == null ? void 0 : _b3.default) === e2;
    }), F = /* @__PURE__ */ Object.create(null), I = (e3) => {
      let t2 = /* @__PURE__ */ Object.create(null);
      for (let [n3, r3] of Object.entries(e3 || {})) t2[n3] = Object.assign(/* @__PURE__ */ Object.create(null), r3);
      return t2;
    }, te = (e3, t2) => {
      var _a3, _b3;
      for (let [n3, r3] of Object.entries(((_a3 = G.shareScopeMap) == null ? void 0 : _a3[e3]) || {})) for (let [e4, i3] of Object.entries(r3 || {})) {
        if (!i3 || i3.get === ((_b3 = R[n3]) == null ? void 0 : _b3.get)) continue;
        let r4 = t2[n3] || (t2[n3] = {});
    ...
    let ce = (e3) => {
      ...
      return t2;
    }, le = [], ue = globalThis.window === void 0 ? await Promise.all([]) : [], H = `__mf_vite_runtime_share_load_id__`, de = 0, U = /* @__PURE__ */ new Map(), W = /* @__PURE__ */ new Map(), G = t({
      name: _,
      remotes: ie,
      shared: R,
      plugins: [
    ...
    function fe() {
      return {
        ...
        resolveShare(e3) {
          var _a3;
          let t2 = (_a3 = e3.shareInfo) == null ? void 0 : _a3[H], n3 = t2 === void 0 ? void 0 : W.get(t2);
          if (!n3) return e3;
          let r3 = e3.resolver;
    ...
    let me = G.sharedHandler.hooks.lifecycle.resolveShare, K = /* @__PURE__ */ new WeakMap();
    me.on((e3) => {
      var _a3;
      let t2 = (_a3 = e3.shareInfo) == null ? void 0 : _a3[H], n3 = e3.resolver;
    ...
    let he = (e3, t2, n3, r3) => {
      ...
      let u3 = l3 == null ? void 0 : l3.factory;
      if (u3 === void 0) {
        c3.release(false);
        return;
      }
      ...
      if (m2 && !d2.some((e4) => e4.provider === m2)) {
        ...
        d2.push({
          ...
          registered: (n3 == null ? void 0 : n3[t3]) === m2,
          loadedFactory: u3
        });
      }
      let h2 = d2.find((e4) => e4.provider === m2) ?? _e(d2, u3);
      if (!c3.release(true, (h2 == null ? void 0 : h2.provider) === c3.provider) || !h2) return;
      ...
      if (!(h2.registered && (n3 == null ? void 0 : n3[h2.version]) !== h2.provider)) return {
        provider: h2.provider,
        selection: h2,
        resolved: v2
      };
    }, q = /* @__PURE__ */ new Set(), J = /* @__PURE__ */ new Map(), be = async (t2, n3, r3) => {
      var _a3, _b3, _c2;
      let o3 = !!((_a3 = n3.shareConfig) == null ? void 0 : _a3.singleton);
      if (!o3 && n3.canLiveRebind !== false) try {
        let s3 = O(r3, t2, n3, `version-first`), c3 = E(r3, s3);
        if (!c3 || ((_b3 = n3.shareConfig) == null ? void 0 : _b3.import) === false && k(s3, n3) || ((_c2 = s3 == null ? void 0 : s3.shareConfig) == null ? void 0 : _c2.import) === false) return;
        let { version: l3 } = c3;
        if (!o3 && l3 !== n3.version || !s3.lib && !s3.loading && !(s3.loaded && typeof s3.get == `function`)) return;
        let d2 = i2(t2, o3, n3.version, n3.scope);
        if (a2(p.share, d2) !== void 0) return;
        let f3 = e2[t2], m2 = f3 == null ? void 0 : f3[l3];
        if (c3.registered && !k(m2, s3)) return;
        let h2, g2 = s3.lib;
        if (!g2 && z(s3) || (!g2 && s3.loading && (g2 = await s3.loading), !g2 && s3.loaded && typeof s3.get == `function` && (g2 = await s3.get()), !g2)) return;
        ...
        let b2 = h2 == null ? void 0 : h2.provider, x2 = h2 == null ? void 0 : h2.selection;
        if (!x2) return;
        let S3 = h2 == null ? void 0 : h2.resolved;
        if (S3 === void 0 || a2(p.share, d2) !== void 0 || x2.registered && (f3 == null ? void 0 : f3[x2.version]) !== b2) return;
      ...
      var _a3, _b3, _c2, _d2;
      try {
        let c3 = i2(t2, (_a3 = n3.shareConfig) == null ? void 0 : _a3.singleton, n3.version, n3.scope), d2 = a2(p.share, c3), f3 = l2(p.share, c3), m2 = O(r3, t2, n3, `version-first`), h2 = m2 || D(r3, t2, n3, `version-first`) || n3, g2 = E(r3, h2);
        if (!g2) return;
        let v2 = k(h2, n3), { version: y3 } = g2;
        if (!((_b3 = n3.shareConfig) == null ? void 0 : _b3.singleton) && y3 !== n3.version) return;
        let b2 = o3 == null ? void 0 : o3[y3], x2 = ee(M2, P2, e2, `default`, t2, g2, m2, b2, `version-first`);
        if (!x2 && !v2) return;
        let { provider: S3, scopeRootProvider: C3 } = x2 || {
          provider: h2,
          scopeRootProvider: void 0
        };
        if (n3.canLiveRebind === false || ((_c2 = n3.shareConfig) == null ? void 0 : _c2.import) === false && k(S3, n3) || ((_d2 = S3 == null ? void 0 : S3.shareConfig) == null ? void 0 : _d2.import) === false || d2 !== void 0 && f3 !== _) return;
        let w3 = e2[t2], T3 = w3 == null ? void 0 : w3[y3];
        if (g2.registered && !C3 && !k(T3, S3)) return;
        let A3 = await ye(t2, n3.shareConfig, w3, y3, T3, S3, g2.registered && !v2), j2 = A3 == null ? void 0 : A3.provider, N3 = A3 == null ? void 0 : A3.selection;
        if (!N3 || k(j2, n3) || s3 && (s3.version !== N3.version || !k({
          from: N3.from
        }, s3.provider)) || q.has(j2)) return;
        let F2 = A3 == null ? void 0 : A3.resolved;
        if (F2 === void 0) return;
        let I2 = a2(p.share, c3), te2 = l2(p.share, c3);
        if (I2 !== void 0 && te2 !== _ || N3.registered && (w3 == null ? void 0 : w3[N3.version]) !== j2) return;
        s3 || J.set(t2, {
          version: N3.version,
          provider: {
            from: N3.from
    ...
    for (let e3 of v) await Promise.all(e3.map(async (e4) => {
      let t2 = R[e4];
      t2 && t2.materialize !== false && !t2.treeShaking && await be(e4, t2, L[e4]);
    }));
    for (let [e3, t2] of Object.entries(R)) {
      if (t2.treeShaking) continue;
      let n3 = i2(e3, (_c = t2.shareConfig) == null ? void 0 : _c.singleton, t2.version, t2.scope);
      if (a2(p.share, n3) !== void 0) continue;
    ...
    p.providerInit || (p.providerInit = /* @__PURE__ */ new Map());
    let Te = (e3, t2) => {
    ...
    var Ee = async (e3) => {
      let t2 = new Set(e3);
      for (let e4 of Ce) await Promise.all(e4.filter((e5) => t2.has(e5)).map(async (e5) => {
        var _a3, _b3;
        let t3 = R[e5], n3 = i2(e5, (_a3 = t3.shareConfig) == null ? void 0 : _a3.singleton, t3.version, t3.scope);
        if (((_b3 = t3.shareConfig) == null ? void 0 : _b3.import) === false || t3.treeShaking || a2(p.share, n3) !== void 0) return;
          ...
          if (!e6 && s3.loading && (e6 = await s3.loading), !e6 && s3.loaded && typeof s3.get == `function` && (e6 = await s3.get()), e6) {
            ...
            u2(p.share, n3, ((e7) => {
              ...
              for (let e8 = 0; e8 < 5; e8++) {
                let e9 = t5 == null ? void 0 : t5.default;
                if (!e9 || typeof e9 != `object` || Object.keys(e9).length === 0) break;
                let n4 = Object.keys(t5).filter((e10) => e10 !== "default").map((e10) => t5[e10]);
                if (n4.length > 0 && n4.some((e10) => e10 !== void 0)) break;
                t5 = e9;
              }
              return t5;
            })(r4), s3.from);
    ...
    let De = (e3) => {
      ...
      let n3 = i2(e3, (_b3 = t2.shareConfig) == null ? void 0 : _b3.singleton, t2.version, t2.scope);
      return t2.treeShaking ? T2(p.share, n3, _) === void 0 && a2(p.share, n3) === void 0 : a2(p.share, n3) === void 0;
    }, Oe = (e3) => {
      var _a3, _b3;
      let t2 = R[e3], n3 = i2(e3, (_a3 = t2.shareConfig) == null ? void 0 : _a3.singleton, t2.version, t2.scope);
      return (t2.treeShaking ? T2(p.share, n3, _) ?? a2(p.share, n3) : a2(p.share, n3)) === void 0 ? t2.treeShaking || ((_b3 = t2.shareConfig) == null ? void 0 : _b3.import) === false ? true : typeof O == `function` && !!O(L[e3], e3, t2, `version-first`) : false;
    }, ke = (e3) => {
      let t2 = true;
      for (; t2; ) {
        t2 = false;
    ...
    re();
    let Me = async () => {
      for (let t2 of v) await Promise.all(t2.map(async (t3) => {
        let n3 = R[t3];
    ...
    try {
      ...
      if (e3) for (let [, n3] of Object.entries(e3)) for (let e4 of h) {
        let r3 = n3 == null ? void 0 : n3[e4];
        if (r3) for (let [e5, n4] of Object.entries(r3)) {
          let r4 = R == null ? void 0 : R[e5], i3 = L[e5], a3 = J.get(e5);
          if (!r4 || !i3 || !a3 || r4.treeShaking) continue;
          let o3 = t2[e5] || (t2[e5] = /* @__PURE__ */ Object.create(null));
          for (let [e6, t3] of Object.entries(n4)) {
            if (!t3.lib || a3.version !== e6 || !k(t3, a3.provider)) continue;
            let n5 = i3[e6];
            (t3 === n5 || (n5 == null ? void 0 : n5.from) && t3.from === n5.from) && (t3 === r4 || r4.from && t3.from === r4.from || o3[e6] === void 0 && (o3[e6] = t3));
          }
        }
      }
      for (let e4 of v) await Promise.all(e4.map(async (e5) => {
        let n3 = t2[e5];
    ...
    let Ne = async () => {
      ...
      var _a3, _b3;
      let r3 = i2(t2, (_a3 = n3.shareConfig) == null ? void 0 : _a3.singleton, n3.version, n3.scope), o3 = n3.treeShaking ? T2(p.share, r3, _) : a2(p.share, r3);
      if (((_b3 = n3.shareConfig) == null ? void 0 : _b3.import) !== false || o3 !== void 0 || se(t2, n3, L[t2])) return;
      let s3 = (e3) => {
        let t3 = e3;
        for (let e4 = 0; e4 < 5; e4++) {
        ...
        return t3;
      }, c3 = e2 == null ? void 0 : e2[t2], l3 = D(c3, t2, n3, `version-first`) || n3, d2 = E(c3, l3);
      if (!d2) return;
      let f3 = (e3) => {
        var _a4;
        return e3 === n3 || ((_a4 = e3 == null ? void 0 : e3.shareConfig) == null ? void 0 : _a4.import) === false;
      };
      if (f3(l3)) return;
      let { version: m2 } = d2, h2 = c3 == null ? void 0 : c3[m2], g2 = await ye(t2, n3.shareConfig, c3, m2, h2, l3, d2.registered), v2 = g2 == null ? void 0 : g2.selection, y3 = g2 == null ? void 0 : g2.provider, b2 = g2 == null ? void 0 : g2.resolved;
      if (!v2 || f3(y3) || b2 === void 0 || (n3.treeShaking ? T2(p.share, r3, _) : a2(p.share, r3)) !== void 0 || v2.registered && (c3 == null ? void 0 : c3[v2.version]) !== y3) return;
      let x2 = s3(b2);
      if (n3.treeShaking) {
        let e3 = n3.treeShaking.providedExports ?? n3.treeShaking.usedExports ?? [];
        S2(p.share, r3, e3, x2), A2(p.share, r3, _, x2);
      } else u2(p.share, r3, x2, v2.from);
    }, Q = [], $ = /* @__PURE__ */ new Set();
    for (let e3 of je) {
      let t2 = R[e3], n3 = Y.get(e3);
      if (De(e3)) try {
        t2.treeShaking ? await Ne(e3, t2) : ((_e2 = t2.shareConfig) == null ? void 0 : _e2.import) === false && await Pe(e3, t2);
      } catch (t3) {
  ...
  if (typeof document !== "undefined" && document.head) {
    try {
      for (const __mfWarmupPath of [
        "assets/_virtual_mf-localSharedImportMap___mfe_internal__vis_mf_2_2_mf_2_scheduler__mf_owner__1-Cf7OxlIZ.js",
