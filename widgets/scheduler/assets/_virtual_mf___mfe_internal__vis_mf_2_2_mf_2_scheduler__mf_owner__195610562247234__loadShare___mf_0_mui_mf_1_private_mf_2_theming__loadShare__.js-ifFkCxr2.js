...
let __tla = (async () => {
  ...
  S === void 0 ? c(a.then(() => {
    ...
    return t(() => import("./_virtual_mf___mfe_internal__vis_mf_2_2_mf_2_scheduler__mf_owner__195610562247234__prebuild___mf_0_mui_mf_1_private_mf_2_theming__prebuild__-B66vmzvg.js").then(async (m2) => {
      await m2.__tla;
      return m2;
    }).then((e2) => {
      S = g(e2), h(s.share, {
