...
import { t } from "./react.production-DPSSDlXY.js";
var n = e(((e2, n2) => {
  n2.exports = t();
})), r = e(((e2) => {
  var t2 = n();
  ...
  var a = { d: { f: i2, r: function() {
    throw Error(r2(522));
  }, D: i2, C: i2, L: i2, m: i2, X: i2, S: i2, M: i2 }, p: 0, findDOMNode: null }, o = /* @__PURE__ */ Symbol.for(`react.portal`), s = /* @__PURE__ */ Symbol.for(`react.recoverable`), c = /* @__PURE__ */ Symbol.for(`react.optimistic_key`);
  function l(e3, t3, n2) {
  ...
  e2.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = a, e2.browser = function(e3) {
    ...
    if (!t3 || t3.nodeType !== 1 && t3.nodeType !== 9 && t3.nodeType !== 11) throw Error(r2(299));
    return l(e3, t3, null, n2);
  }, e2.flushSync = function(e3) {
    var t3 = u.T, n2 = a.p;
    try {
      if (u.T = null, a.p = 2, e3) return e3();
    } finally {
      u.T = t3, a.p = n2, a.d.f();
    }
