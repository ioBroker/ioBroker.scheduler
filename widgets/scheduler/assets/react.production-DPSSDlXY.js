...
var t = e(((e2) => {
  var t2 = /* @__PURE__ */ Symbol.for(`react.transitional.element`), n = /* @__PURE__ */ Symbol.for(`react.portal`), r = /* @__PURE__ */ Symbol.for(`react.fragment`), i = /* @__PURE__ */ Symbol.for(`react.strict_mode`), a = /* @__PURE__ */ Symbol.for(`react.profiler`), o = /* @__PURE__ */ Symbol.for(`react.consumer`), s = /* @__PURE__ */ Symbol.for(`react.context`), c = /* @__PURE__ */ Symbol.for(`react.forward_ref`), l = /* @__PURE__ */ Symbol.for(`react.suspense`), u = /* @__PURE__ */ Symbol.for(`react.memo`), d = /* @__PURE__ */ Symbol.for(`react.lazy`), f = /* @__PURE__ */ Symbol.for(`react.activity`), p = /* @__PURE__ */ Symbol.for(`react.view_transition`), m = Symbol.iterator;
  function h(e3) {
  ...
  function P(e3, r2, i2, a2, o2) {
    ...
    if (c2) return o2 = o2(e3), c2 = a2 === `` ? `.` + M(e3, 0) : a2, C(o2) ? (i2 = ``, c2 != null && (i2 = c2.replace(j, `$&/`) + `/`), P(o2, r2, i2, ``, function(e4) {
      return e4;
    })) : o2 != null && (k(o2) && (o2 = O(o2, i2 + (o2.key == null || e3 && e3.key === o2.key ? `` : (`` + o2.key).replace(j, `$&/`) + `/`) + c2)), r2.push(o2)), 1;
    c2 = 0;
    var l2 = a2 === `` ? `.` : a2 + `:`;
    if (C(e3)) for (var u2 = 0; u2 < e3.length; u2++) a2 = e3[u2], s2 = l2 + M(a2, u2), c2 += P(a2, r2, i2, s2, o2);
    else if (u2 = h(e3), typeof u2 == `function`) for (e3 = u2.call(e3), u2 = 0; !(a2 = e3.next()).done; ) a2 = a2.value, s2 = l2 + M(a2, u2++), c2 += P(a2, r2, i2, s2, o2);
    else if (s2 === `object`) {
      if (typeof e3.then == `function`) return P(N(e3), r2, i2, a2, o2);
  ...
  var B = { map: F, forEach: function(e3, t3, n2) {
    ...
    if (!k(e3)) throw Error(`React.Children.only expected to receive a single React element child.`);
    return e3;
  } };
  e2.Activity = f, e2.Children = B, e2.Component = y, e2.Fragment = r, e2.Profiler = a, e2.PureComponent = x, e2.StrictMode = i, e2.Suspense = l, e2.ViewTransition = p, e2.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = T, e2.__COMPILER_RUNTIME = { __proto__: null, c: function(e3) {
    ...
    if (t3 != null) for (a2 in t3.key !== void 0 && (i2 = `` + t3.key), t3) !E.call(t3, a2) || a2 === `key` || a2 === `__self` || a2 === `__source` || a2 === `ref` && t3.ref === void 0 || (r2[a2] = t3[a2]);
    var a2 = arguments.length - 2;
    if (a2 === 1) r2.children = n2;
    else if (1 < a2) {
      for (var o2 = Array(a2), s2 = 0; s2 < a2; s2++) o2[s2] = arguments[s2 + 2];
      r2.children = o2;
    }
    ...
    var r2, i2 = {}, a2 = null;
    if (t3 != null) for (r2 in t3.key !== void 0 && (a2 = `` + t3.key), t3) E.call(t3, r2) && r2 !== `key` && r2 !== `__self` && r2 !== `__source` && (i2[r2] = t3[r2]);
    var o2 = arguments.length - 2;
    if (o2 === 1) i2.children = n2;
    else if (1 < o2) {
      for (var s2 = Array(o2), c2 = 0; c2 < o2; c2++) s2[c2] = arguments[c2 + 2];
      i2.children = s2;
    }
    if (e3 && e3.defaultProps) for (r2 in o2 = e3.defaultProps, o2) i2[r2] === void 0 && (i2[r2] = o2[r2]);
    return D(e3, a2, i2);
