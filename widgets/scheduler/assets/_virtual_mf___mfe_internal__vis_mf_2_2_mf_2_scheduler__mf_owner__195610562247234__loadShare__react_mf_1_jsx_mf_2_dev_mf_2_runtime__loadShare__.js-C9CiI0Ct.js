...
let __tla = (async () => {
  ...
  x === void 0 ? c(a.then(() => {
    ...
    return t(() => import("./_virtual_mf___mfe_internal__vis_mf_2_2_mf_2_scheduler__mf_owner__195610562247234__prebuild__react_mf_1_jsx_mf_2_dev_mf_2_runtime__prebuild__-Cbwz_BNS.js").then(async (m2) => {
      await m2.__tla;
      return m2;
    }).then((e2) => {
      x = g(e2), h(s.share, {
