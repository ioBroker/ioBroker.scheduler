let index_cjs$3, init_1, vis_mf_2_2_mf_2_scheduler__mf_v__runtimeInit__mf_v__;
let __tla = (async () => {
...
`);
 ...
 ${sdk.safeToString(this.remoteInfo)}`), this.remoteEntryExports = e, this.remoteEntryExports;
  ...
  vis_mf_2_2_mf_2_scheduler__mf_v__runtimeInit__mf_v__ = {
    initPromise,
    initResolve
  };
})();
export {
  ...
  index_cjs$3 as a,
  init_1 as i,
  vis_mf_2_2_mf_2_scheduler__mf_v__runtimeInit__mf_v__ as v
};
