import { g as e, h as t } from "./_virtual_mf___mfe_internal__vis_mf_2_2_mf_2_scheduler__mf_owner__195610562247234__loadShare__react__loadShare__.js-DfDU6gQX.js";
function n(e2) {
...
var c = { animationIterationCount: 1, aspectRatio: 1, borderImageOutset: 1, borderImageSlice: 1, borderImageWidth: 1, boxFlex: 1, boxFlexGroup: 1, boxOrdinalGroup: 1, columnCount: 1, columns: 1, flex: 1, flexGrow: 1, flexPositive: 1, flexShrink: 1, flexNegative: 1, flexOrder: 1, gridRow: 1, gridRowEnd: 1, gridRowSpan: 1, gridRowStart: 1, gridColumn: 1, gridColumnEnd: 1, gridColumnSpan: 1, gridColumnStart: 1, msGridRow: 1, msGridRowSpan: 1, msGridColumn: 1, msGridColumnSpan: 1, fontWeight: 1, lineHeight: 1, opacity: 1, order: 1, orphans: 1, scale: 1, tabSize: 1, widows: 1, zIndex: 1, zoom: 1, WebkitLineClamp: 1, fillOpacity: 1, floodOpacity: 1, stopOpacity: 1, strokeDasharray: 1, strokeDashoffset: 1, strokeMiterlimit: 1, strokeOpacity: 1, strokeWidth: 1 }, l = /[A-Z]|^ms/g, u = /_EMO_([^_]+?)_([^]*?)_EMO_/g, d = function(e2) {
  ...
  switch (e2) {
    case `animation`:
    case `animationName`:
      if (typeof t2 == `string`) return t2.replace(u, function(e3, t3, n2) {
...
function h(e2, t2, n2) {
  ...
  switch (typeof n2) {
    ...
    case `object`:
      var i2 = n2;
      if (i2.anim === 1) return v = { name: i2.name, styles: i2.styles, next: v }, i2.name;
      var a2 = n2;
      if (a2.styles !== void 0) {
        var o2 = a2.next;
        if (o2 !== void 0) for (; o2 !== void 0; ) v = { name: o2.name, styles: o2.styles, next: v }, o2 = o2.next;
        return a2.styles + `;`;
      }
      return g(e2, t2, n2);
    case `function`:
...
function g(e2, t2, n2) {
  var r2 = ``;
  if (Array.isArray(n2)) for (var i2 = 0; i2 < n2.length; i2++) r2 += h(e2, t2, n2[i2]) + `;`;
  else for (var a2 in n2) {
    var o2 = n2[a2];
    if (typeof o2 != `object`) {
      var s2 = o2;
      t2 != null && t2[s2] !== void 0 ? r2 += a2 + `{` + t2[s2] + `}` : f(s2) && (r2 += p(a2) + `:` + m(a2, s2) + `;`);
    } else if (Array.isArray(o2) && typeof o2[0] == `string` && (t2 == null || t2[o2[0]] === void 0)) for (var c2 = 0; c2 < o2.length; c2++) f(o2[c2]) && (r2 += p(a2) + `:` + m(a2, o2[c2]) + `;`);
    else {
      var l2 = h(e2, t2, o2);
      switch (a2) {
        case `animation`:
...
function y(e2, t2, n2) {
  ...
  for (var o2 = 1; o2 < e2.length; o2++) i2 += h(n2, t2, e2[o2]), r2 && (i2 += a2[o2]);
  _.lastIndex = 0;
  for (var c2 = ``, l2; (l2 = _.exec(i2)) !== null; ) c2 += `-` + l2[1];
