...
import { FormLabel, Chip, Tooltip, Fab } from '@mui/material';
import { Add as IconAdd } from '@mui/icons-material';

import { I18n, DialogSelectID, Utils, Icon } from '@iobroker/adapter-react-v5';
                            ...
                            <span key={id}>
                                ...
                                >
                                    <Chip
                                        ...
                                        style={{
                                            ...styles.chip,
                                            backgroundColor: errors[id].length ? 'red' : undefined,
                                        }}
